...
python -m realhf.apps.quickstart cgpo \
    ...
    task0.actor.optimizer.warmup_steps_proportion=0.0 \
    task0.actor.optimizer.weight_decay=0.0 \
    task0.actor.optimizer.lr=0.01 \
    ...
    task1.cgpo.adv_norm=True task0.cgpo.value_norm=True \
    ...
    task1.actor.optimizer.warmup_steps_proportion=0.0 \
