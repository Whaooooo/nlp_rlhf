...
class ClipSFTConfig(CommonExperimentConfig):
    """Configuration for ClipSFT experiments.
    ...
    def rpcs(self):
        rpc = MFCDef(
            ...
            interface_impl=ModelInterfaceAbstraction("clip-sft", args = {"clip_ratio": self.clip_ratio}),
            model_name="default",
...
register_quickstart_exp("clip-sft", ClipSFTConfig)
